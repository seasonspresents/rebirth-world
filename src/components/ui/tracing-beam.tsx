          ...
          animate={{
            boxShadow:
              scrollYProgress.get() > 0
                ? "none"
                : "rgba(45, 138, 126, 0.35) 0px 3px 12px 0px",
          }}
        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="#2d8a7e" stopOpacity="0" />
              <stop stopColor="#2d8a7e" />
              <stop offset="0.325" stopColor="#cc7e3a" />
              <stop offset="1" stopColor="#4d7a4e" stopOpacity="0" />
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
