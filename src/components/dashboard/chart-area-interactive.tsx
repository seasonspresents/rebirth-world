    ...
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardDescription>
          ...
          <span className="@[540px]/card:hidden">Order activity</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger
              className="flex w-[130px] **:data-[slot=select-value]:block **:data-[slot=select-value]:truncate @[767px]/card:hidden"
              size="sm"
